...
const Oyin = () => {
  ...
  return (
    <div className="w-full h-full items-center scroll-smooth flex flex-col py-2 col-auto bg-black dark:bg-white">
      {/* NAV */}
      ...
      <div className="h-[800px] w-[1288px] bg-black dark:bg-white flex flex-col gap-24` py-28` justify-center">
        ...
        <div className="w-[full] text-[#ffffff] dark:text-black font-bold  flex justify-end text-right">
          <p className="w-[689px] font-light text-[32px] ">
            ...
            THE DARKEST DAYS. HER SUPPORT IS MY GREATEST BLESSING. SHE IS NOT
            ONLY MY PARTNER BUT MY HERO, AND EVERY MOMENT WITH HER IS A GIFT I
            CHERISH DEEPLY.
          </p>
        </div>
      </div>
